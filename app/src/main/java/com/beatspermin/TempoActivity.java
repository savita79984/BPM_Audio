...
public class TempoActivity extends Activity {
	...
	private void initialize() {
		...
		bpmTextView.setText(getApplicationContext().getResources().getString(R.string.initial_bpm_value));
	...
	private void updateView() {
		...
		if (bpmCalculator.times.size() >= 2) {
			...
			displayValue = getApplicationContext().getResources().getString(R.string.tap_again);
		}
